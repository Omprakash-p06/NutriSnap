  ...
  return (
    <div style={styles.overlay}>
      <div className="glass-card" style={styles.modal}>
        ...
        <h2 style={{ textAlign: 'center', marginBottom: '20px' }} className="text-gradient">
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <button className="clay-btn" type="submit" disabled={loading} style={{ width: '100%', marginTop: '10px' }}>
