  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Suggested Meals</h3>
          <p className="text-sm text-gray-500">Based on your remaining macros</p>
        </div>
        <button
        ...
        >
          <RefreshCw size={20} className={refreshKey > 0 ? "animate-spin-once" : ""} />
        </button>
      </div>
      ...
      {suggestions.length > 0 ? (
        ...
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-sm mt-1">Try eating a light snack or adjusting targets.</p>
        </div>
      )}
    </div>
  );
